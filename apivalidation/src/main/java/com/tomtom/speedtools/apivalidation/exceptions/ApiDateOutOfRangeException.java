...
public final class ApiDateOutOfRangeException extends ApiBadRequestException {
    ...
    public ApiDateOutOfRangeException(
            @Nonnull final String parameter,
            @Nullable final DateTime actual,
            @Nonnull final DateTime minValue,
            @Nonnull final DateTime maxValue) {
        super(new ApiDateOutOfRangeError(parameter, actual, minValue, maxValue));
    }
}
