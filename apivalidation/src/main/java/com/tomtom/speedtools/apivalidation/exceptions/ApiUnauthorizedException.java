...
public final class ApiUnauthorizedException extends ApiException {
    ...
    public ApiUnauthorizedException(@Nonnull final String message) {
        super(message);
        assert message != null;
    }

    public ApiUnauthorizedException(@Nonnull final String message, @Nonnull final Throwable cause) {
        super(message, cause);
        assert message != null;
        assert cause != null;
    }

    public ApiUnauthorizedException(@Nonnull final Throwable cause) {
        super(cause);
        assert cause != null;
    }
}
